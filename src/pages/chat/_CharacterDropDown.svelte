...
<select bind:value={selected_character} on:change={on_change} class="pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline">
